<div class="container">
    ...
    <form wire:submit.prevent="editCategory">
        ...
        <div class="mb-3 row">
            <div class="col">
                ...
                <div class="form-check">
                    <input type="radio" id="status_enabled" class="form-check-input" value="1" wire:model="status">
                    <label for="status_enabled" class="form-check-label">Enabled</label>
                </div>
                <div class="form-check">
                    <input type="radio" id="status_disabled" class="form-check-input" value="0" wire:model="status">
        ...
        <div class="mb-3">
            ...
            @else
                <img src="{{ asset('images/default.png') }}" class="w-24 h-24 rounded-lg shadow-md object-cover"
                    width="150">
            @endif
        </div>

        <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
            <span wire:loading.remove wire:target="editCategory">Submit</span>
            <span wire:loading wire:target="editCategory">
